...
def main():
    ...
    AttnIO_dataset_test = AttnIODataset(opt=opt_dataset_test, transform=transforms.Compose([ToTensor(opt_dataset_test)]))
    ...
    AttnIODatasetLoaderTest = DataLoader(AttnIO_dataset_test, batch_size=8, shuffle=True, num_workers=0, collate_fn=attnIO_collate)
